...
export const ComponyT=(us:UserBookType& ComponyType,id:number, comp:string)=>{
	return{...us, address:{...us.address},
		companies: us.companies.map(c=> c.id ===id? {...c, name:comp} :c )

		//companies: [{...us.companies[0]}, {...us.companies[1] },]
		 }
}